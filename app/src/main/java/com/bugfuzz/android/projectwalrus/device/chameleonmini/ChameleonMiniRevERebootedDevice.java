...
@CardDevice.UsbIds({@CardDevice.UsbIds.Ids(vendorId = 0x03EB, productId = 0x2044)}) //Chameleon Mini Rev.E Rebooted
public class ChameleonMiniRevERebootedDevice extends LineBasedSerialCardDevice
